 ...
 *
 * X2CscopeComm.h — UART example
 *
 * Copy this file and X2CscopeComm.c into your project's X2Cscope folder.
 * Adapt the UART driver include in X2CscopeComm.c to your MCC-generated driver.
 */
...
/* flushSerial is not needed for UART — NULL is passed to X2Cscope_InitialiseEx() */
